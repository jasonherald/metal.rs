...
fn main() {
    ...
    match metal::mtl4::MachineLearningPipelineDescriptor::new() {
        Some(ml_desc) => {
    ...
    match metal::mtl4::ArgumentTableDescriptor::new() {
        Some(table_desc) => {
    ...
    let compiler_desc = match metal::mtl4::CompilerDescriptor::new() {
        Some(desc) => {
    ...
    heap_desc.set_storage_mode(metal::enums::StorageMode::PRIVATE);
