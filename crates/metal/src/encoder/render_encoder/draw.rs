...
impl RenderCommandEncoder {
    ...
    pub fn draw_primitives(
        ...
        unsafe {
            metal_sys::msg_send_3::<(), PrimitiveType, UInteger, UInteger>(
                self.as_ptr(),
    ...
    pub fn draw_primitives_instanced(
        ...
        unsafe {
            metal_sys::msg_send_4::<(), PrimitiveType, UInteger, UInteger, UInteger>(
                self.as_ptr(),
    ...
    pub fn draw_primitives_indirect(
        ...
        unsafe {
            metal_sys::msg_send_3::<(), PrimitiveType, *const c_void, UInteger>(
                self.as_ptr(),
    ...
    pub fn draw_indexed_primitives(
        ...
        unsafe {
            metal_sys::msg_send_5::<(), PrimitiveType, UInteger, IndexType, *const c_void, UInteger>(
                self.as_ptr(),
    ...
    pub fn draw_patches_indirect(
        ...
        let patch_index_buffer_ptr = patch_index_buffer
            ...
            .unwrap_or(std::ptr::null());
        unsafe {
            metal_sys::msg_send_5::<(), UInteger, *const c_void, UInteger, *const c_void, UInteger>(
                self.as_ptr(),
    ...
    pub fn draw_mesh_threadgroups(
        ...
        unsafe {
            metal_sys::msg_send_3::<(), Size, Size, Size>(
                self.as_ptr(),
    ...
    pub fn draw_mesh_threadgroups_indirect(
        ...
        unsafe {
            metal_sys::msg_send_4::<(), *const c_void, UInteger, Size, Size>(
                self.as_ptr(),
