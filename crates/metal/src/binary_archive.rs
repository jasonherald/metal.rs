...
impl BinaryArchiveDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = metal_sys::Class::get("MTLBinaryArchiveDescriptor")?;
    ...
    pub fn url(&self) -> Option<metal_foundation::Url> {
        unsafe {
            ...
            metal_foundation::Url::from_ptr(ptr)
        }
    }
    ...
    pub fn set_url(&self, url: &metal_foundation::Url) {
        unsafe {
