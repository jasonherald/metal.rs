...
impl StaticLinkingDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = metal_sys::Class::get("MTL4StaticLinkingDescriptor")?;
...
impl PipelineStageDynamicLinkingDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = metal_sys::Class::get("MTL4PipelineStageDynamicLinkingDescriptor")?;
            let ptr: *mut c_void = msg_send_0(class.as_ptr(), sel!(alloc));
            if ptr.is_null() {
                return None;
            }
...
impl RenderPipelineDynamicLinkingDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = metal_sys::Class::get("MTL4RenderPipelineDynamicLinkingDescriptor")?;
            let ptr: *mut c_void = msg_send_0(class.as_ptr(), sel!(alloc));
            if ptr.is_null() {
                return None;
            }
