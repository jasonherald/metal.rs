...
#[repr(transparent)]
pub struct IndirectInstanceAccelerationStructureDescriptor(NonNull<c_void>);
...
impl IndirectInstanceAccelerationStructureDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class =
                metal_sys::Class::get("MTL4IndirectInstanceAccelerationStructureDescriptor")?;
    ...
    pub fn instance_count_buffer(&self) -> BufferRange {
        unsafe { msg_send_0(self.as_ptr(), sel!(instanceCountBuffer)) }
    }

    /// Set the instance count buffer.
    pub fn set_instance_count_buffer(&self, buffer: BufferRange) {
        unsafe {
            let _: () = msg_send_1(self.as_ptr(), sel!(setInstanceCountBuffer:), buffer);
        }
    }
    ...
    pub fn set_max_instance_count(&self, count: UInteger) {
        unsafe {
            let _: () = msg_send_1(self.as_ptr(), sel!(setMaxInstanceCount:), count);
        }
    }
    ...
    pub fn set_max_motion_transform_count(&self, count: UInteger) {
        unsafe {
            let _: () = msg_send_1(self.as_ptr(), sel!(setMaxMotionTransformCount:), count);
        }
    }
    ...
    pub fn motion_transform_count_buffer(&self) -> BufferRange {
        unsafe { msg_send_0(self.as_ptr(), sel!(motionTransformCountBuffer)) }
    }

    /// Set the motion transform count buffer.
    pub fn set_motion_transform_count_buffer(&self, buffer: BufferRange) {
        unsafe {
            let _: () = msg_send_1(self.as_ptr(), sel!(setMotionTransformCountBuffer:), buffer);
        }
    }
...
impl Default for IndirectInstanceAccelerationStructureDescriptor {
    fn default() -> Self {
        Self::new().expect("Failed to create MTL4IndirectInstanceAccelerationStructureDescriptor")
    }
}
...
impl std::fmt::Debug for IndirectInstanceAccelerationStructureDescriptor {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("IndirectInstanceAccelerationStructureDescriptor")
