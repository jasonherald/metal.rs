...
/// Descriptor for motion curve geometry in an acceleration structure.
///
/// C++ equivalent: `MTL4::AccelerationStructureMotionCurveGeometryDescriptor`
#[repr(transparent)]
pub struct AccelerationStructureMotionCurveGeometryDescriptor(NonNull<c_void>);
...
impl AccelerationStructureMotionCurveGeometryDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class =
                metal_sys::Class::get("MTL4AccelerationStructureMotionCurveGeometryDescriptor")?;
    ...
    /// Get the control point buffers (for motion keyframes).
    pub fn control_point_buffers(&self) -> BufferRange {
        unsafe { msg_send_0(self.as_ptr(), sel!(controlPointBuffers)) }
    }

    /// Set the control point buffers.
    pub fn set_control_point_buffers(&self, buffers: BufferRange) {
        unsafe {
            let _: () = msg_send_1(self.as_ptr(), sel!(setControlPointBuffers:), buffers);
        }
    }
    ...
    /// Get the radius buffers (for motion keyframes).
    pub fn radius_buffers(&self) -> BufferRange {
        unsafe { msg_send_0(self.as_ptr(), sel!(radiusBuffers)) }
    }

    /// Set the radius buffers.
    pub fn set_radius_buffers(&self, buffers: BufferRange) {
        unsafe {
            let _: () = msg_send_1(self.as_ptr(), sel!(setRadiusBuffers:), buffers);
        }
    }
...
impl Default for AccelerationStructureMotionCurveGeometryDescriptor {
    fn default() -> Self {
        Self::new()
            .expect("Failed to create MTL4AccelerationStructureMotionCurveGeometryDescriptor")
    }
}

impl Clone for AccelerationStructureMotionCurveGeometryDescriptor {
    fn clone(&self) -> Self {
        unsafe {
...
impl Referencing for AccelerationStructureMotionCurveGeometryDescriptor {
    #[inline]
...
unsafe impl Send for AccelerationStructureMotionCurveGeometryDescriptor {}
unsafe impl Sync for AccelerationStructureMotionCurveGeometryDescriptor {}

impl std::fmt::Debug for AccelerationStructureMotionCurveGeometryDescriptor {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("AccelerationStructureMotionCurveGeometryDescriptor")
