//! Motion curve geometry descriptor for acceleration structures.
...
#[repr(transparent)]
pub struct AccelerationStructureMotionCurveGeometryDescriptor(pub(crate) NonNull<c_void>);
...
impl AccelerationStructureMotionCurveGeometryDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class =
                metal_sys::Class::get("MTLAccelerationStructureMotionCurveGeometryDescriptor")?;
    ...
    // Motion curve-specific properties
...
impl Default for AccelerationStructureMotionCurveGeometryDescriptor {
    fn default() -> Self {
        Self::new().expect("failed to create motion curve geometry descriptor")
    }
}
...
impl Clone for AccelerationStructureMotionCurveGeometryDescriptor {
    fn clone(&self) -> Self {
        unsafe {
            ...
            Self::from_raw(ptr).expect("failed to copy motion curve geometry descriptor")
        }
    }
}
