...
impl FunctionConstantValues {
    ...
    pub fn alloc() -> Option<Self> {
        unsafe {
            let cls = metal_sys::Class::get("MTLFunctionConstantValues")?;
    ...
    pub unsafe fn set_constant_value_at_index(
        ...
        unsafe {
            metal_sys::msg_send_3::<(), *const c_void, crate::DataType, UInteger>(
                self.as_ptr(),
    ...
    pub unsafe fn set_constant_value_with_name(
        ...
        if let Some(ns_name) = metal_foundation::String::from_str(name) {
            unsafe {
                metal_sys::msg_send_3::<(), *const c_void, crate::DataType, *const c_void>(
                    self.as_ptr(),
    ...
    pub unsafe fn set_constant_values(
        ...
        unsafe {
            metal_sys::msg_send_3::<(), *const c_void, crate::DataType, metal_foundation::Range>(
                self.as_ptr(),
