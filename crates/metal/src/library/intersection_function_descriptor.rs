...
#[repr(transparent)]
pub struct IntersectionFunctionDescriptor(pub(crate) NonNull<c_void>);
...
impl IntersectionFunctionDescriptor {
    ...
    pub fn alloc() -> Option<Self> {
        unsafe {
            let cls = metal_sys::Class::get("MTLIntersectionFunctionDescriptor")?;
    ...
    /// Create a new intersection function descriptor.
    ...
    // =========================================================================
    // Inherited from FunctionDescriptor
    // =========================================================================
...
impl Default for IntersectionFunctionDescriptor {
    fn default() -> Self {
        Self::new().expect("failed to create IntersectionFunctionDescriptor")
    }
}
...
impl Clone for IntersectionFunctionDescriptor {
    fn clone(&self) -> Self {
        unsafe {
            ...
            Self::from_raw(ptr).expect("failed to copy IntersectionFunctionDescriptor")
        }
    }
}
...
impl Referencing for IntersectionFunctionDescriptor {
    #[inline]
...
unsafe impl Send for IntersectionFunctionDescriptor {}
unsafe impl Sync for IntersectionFunctionDescriptor {}

impl std::fmt::Debug for IntersectionFunctionDescriptor {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("IntersectionFunctionDescriptor")
