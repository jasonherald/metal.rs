...
use metal_sys::{msg_send_0, msg_send_1, msg_send_2, msg_send_5, msg_send_9, sel};
...
impl IOCommandBuffer {
    ...
    pub unsafe fn load_bytes(
        ...
        unsafe {
            metal_sys::msg_send_4::<(), *mut c_void, UInteger, *const c_void, UInteger>(
                self.as_ptr(),
    ...
    {
        let block = metal_sys::OneArgBlock::from_fn(move |cmd_buf: *mut c_void| {
            unsafe {
