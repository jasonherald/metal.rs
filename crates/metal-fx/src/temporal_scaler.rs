...
impl TemporalScalerDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = metal_sys::Class::get("MTLFXTemporalScalerDescriptor")?;
    ...
    pub fn reactive_mask_texture_format(&self) -> metal::PixelFormat {
        unsafe { msg_send_0(self.as_ptr(), sel!(reactiveMaskTextureFormat)) }
    }

    /// Set the reactive mask texture format.
    pub fn set_reactive_mask_texture_format(&self, format: metal::PixelFormat) {
        unsafe {
    ...
    pub fn supports_device(device: &metal::Device) -> bool {
        unsafe {
            let class = match metal_sys::Class::get("MTLFXTemporalScalerDescriptor") {
                Some(c) => c,
                None => return false,
            };
...
impl TemporalScaler {
    ...
    pub fn reactive_texture_usage(&self) -> metal::TextureUsage {
    ...
    pub fn exposure_texture(&self) -> Option<metal::Texture> {
        unsafe {
    ...
    pub fn set_exposure_texture(&self, texture: &metal::Texture) {
        unsafe {
    ...
    pub fn reactive_mask_texture(&self) -> Option<metal::Texture> {
        unsafe {
    ...
    pub fn set_reactive_mask_texture(&self, texture: &metal::Texture) {
        unsafe {
            let _: () = msg_send_1(
                self.as_ptr(),
    ...
    pub fn reactive_texture_format(&self) -> metal::PixelFormat {
