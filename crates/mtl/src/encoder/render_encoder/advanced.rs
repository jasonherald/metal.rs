...
impl RenderCommandEncoder {
    ...
    pub fn memory_barrier_with_scope(
        ...
        unsafe {
            mtl_sys::msg_send_3::<(), BarrierScope, RenderStages, RenderStages>(
                self.as_ptr(),
    ...
    pub unsafe fn memory_barrier_with_resources_ptr(
        ...
        unsafe {
            mtl_sys::msg_send_4::<(), *const *const c_void, UInteger, RenderStages, RenderStages>(
                self.as_ptr(),
    ...
    pub unsafe fn use_resource_ptr(&self, resource: *const c_void, usage: ResourceUsage) {
        unsafe {
            mtl_sys::msg_send_2::<(), *const c_void, ResourceUsage>(
                self.as_ptr(),
    ...
    pub unsafe fn use_resource_ptr_with_stages(
        ...
        unsafe {
            mtl_sys::msg_send_3::<(), *const c_void, ResourceUsage, RenderStages>(
                self.as_ptr(),
    ...
    pub unsafe fn use_heap_ptr_with_stages(&self, heap: *const c_void, stages: RenderStages) {
        unsafe {
            mtl_sys::msg_send_2::<(), *const c_void, RenderStages>(
                self.as_ptr(),
                sel!(useHeap: stages:),
                heap,
                stages,
    ...
    pub unsafe fn use_heaps_with_stages_ptr(
        ...
        unsafe {
            mtl_sys::msg_send_3::<(), *const *const c_void, UInteger, RenderStages>(
                self.as_ptr(),
    ...
    pub unsafe fn use_resources_ptr(
        ...
        unsafe {
            mtl_sys::msg_send_3::<(), *const *const c_void, UInteger, ResourceUsage>(
                self.as_ptr(),
    ...
    pub unsafe fn use_resources_with_stages_ptr(
        ...
        unsafe {
            mtl_sys::msg_send_4::<(), *const *const c_void, UInteger, ResourceUsage, RenderStages>(
                self.as_ptr(),
    ...
    pub fn set_vertex_amplification_count(
        ...
        unsafe {
            mtl_sys::msg_send_2::<(), UInteger, *const VertexAmplificationViewMapping>(
                self.as_ptr(),
