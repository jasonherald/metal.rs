...
impl Library {
    ...
    ) -> Result<Function, mtl_foundation::Error> {
        let ns_name = mtl_foundation::String::from_str(name).ok_or_else(|| {
            mtl_foundation::Error::error(std::ptr::null_mut(), 0, std::ptr::null_mut())
        ...
        unsafe {
            ...
            if ptr.is_null() {
                if !error.is_null() {
                    ...
                    return Err(mtl_foundation::Error::from_ptr(error).unwrap());
                }
    ...
    pub fn function_names(&self) -> Vec<String> {
        unsafe {
            ...
            for i in 0..count {
                ...
                if !obj.is_null() {
                    let utf8_ptr: *const std::ffi::c_char =
                        mtl_sys::msg_send_0(obj as *const c_void, sel!(UTF8String));
                    if !utf8_ptr.is_null() {
                        let c_str = std::ffi::CStr::from_ptr(utf8_ptr);
    ...
    pub fn new_function_with_name_and_constants_async<F>(
        ...
        F: Fn(Option<Function>, Option<mtl_foundation::Error>) + Send + 'static,
    {
        let Some(ns_name) = mtl_foundation::String::from_str(name) else {
            completion_handler(
                None,
        ...
        let block =
            mtl_sys::TwoArgBlock::from_fn(move |fn_ptr: *mut c_void, err_ptr: *mut c_void| {
        ...
        unsafe {
            mtl_sys::msg_send_3::<(), *const c_void, *const c_void, *const c_void>(
                self.as_ptr(),
        ...
        F: Fn(Option<Function>, Option<mtl_foundation::Error>) + Send + 'static,
    {
        ...
        unsafe {
            mtl_sys::msg_send_2::<(), *const c_void, *const c_void>(
                self.as_ptr(),
