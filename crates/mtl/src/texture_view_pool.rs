...
impl TextureViewPool {
    ...
    pub fn copy_resource_views_from_pool(
        ...
        unsafe {
            let range = mtl_foundation::Range::new(source_location, source_length);
            msg_send_3::<(), *const c_void, mtl_foundation::Range, UInteger>(
                self.as_ptr(),
    ...
    pub fn set_texture_view_from_buffer(
        ...
        unsafe {
            mtl_sys::msg_send_5::<(), *const c_void, *const c_void, UInteger, UInteger, UInteger>(
                self.as_ptr(),
