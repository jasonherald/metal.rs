...
impl TextureViewDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = mtl_sys::Class::get("MTLTextureViewDescriptor")?;
    ...
    /// Get the level range.
    #[inline]
    pub fn level_range(&self) -> mtl_foundation::Range {
        unsafe { msg_send_0(self.as_ptr(), sel!(levelRange)) }
    }

    /// Get the slice range.
    #[inline]
    pub fn slice_range(&self) -> mtl_foundation::Range {
    ...
    /// Set the level range.
    #[inline]
    pub fn set_level_range(&self, range: mtl_foundation::Range) {
        unsafe {
            msg_send_1::<(), mtl_foundation::Range>(self.as_ptr(), sel!(setLevelRange:), range);
        }
    }

    /// Set the slice range.
    #[inline]
    pub fn set_slice_range(&self, range: mtl_foundation::Range) {
        unsafe {
            msg_send_1::<(), mtl_foundation::Range>(self.as_ptr(), sel!(setSliceRange:), range);
        }
    }
