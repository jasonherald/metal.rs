...
impl Texture {
    ...
    pub fn new_texture_view(
        ...
        level_range: mtl_foundation::Range,
        slice_range: mtl_foundation::Range,
    ) -> Option<Texture> {
        unsafe {
    ...
    pub fn new_texture_view_with_swizzle(
        ...
        unsafe {
            let ptr: *mut c_void = mtl_sys::msg_send_5(
                self.as_ptr(),
    ...
    pub unsafe fn get_bytes_simple(
        ...
        unsafe {
            mtl_sys::msg_send_4::<(), *mut c_void, UInteger, crate::types::Region, UInteger>(
                self.as_ptr(),
    ...
    pub unsafe fn replace_region_simple(
        ...
        unsafe {
            mtl_sys::msg_send_4::<(), crate::types::Region, UInteger, *const c_void, UInteger>(
                self.as_ptr(),
