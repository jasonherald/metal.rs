...
use mtl_sys::{msg_send_0, msg_send_1, msg_send_2, msg_send_3, msg_send_4, sel};
...
impl CommitOptions {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = mtl_sys::Class::get("MTL4CommitOptions")?;
    ...
    {
        let block = mtl_sys::OneArgBlock::from_fn(move |feedback_ptr: *mut c_void| {
            unsafe {
...
impl CommandQueueDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = mtl_sys::Class::get("MTL4CommandQueueDescriptor")?;
            let ptr: *mut c_void = msg_send_0(class.as_ptr(), sel!(alloc));
            if ptr.is_null() {
                return None;
            }
