...
impl RenderPipelineColorAttachmentDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = mtl_sys::Class::get("MTL4RenderPipelineColorAttachmentDescriptor")?;
...
impl RenderPipelineColorAttachmentDescriptorArray {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = mtl_sys::Class::get("MTL4RenderPipelineColorAttachmentDescriptorArray")?;
            let ptr: *mut c_void = msg_send_0(class.as_ptr(), sel!(alloc));
            if ptr.is_null() {
                return None;
            }
...
impl RenderPipelineBinaryFunctionsDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = mtl_sys::Class::get("MTL4RenderPipelineBinaryFunctionsDescriptor")?;
            let ptr: *mut c_void = msg_send_0(class.as_ptr(), sel!(alloc));
            if ptr.is_null() {
                return None;
            }
...
impl RenderPipelineDescriptor {
    ...
    pub fn new() -> Option<Self> {
        unsafe {
            let class = mtl_sys::Class::get("MTL4RenderPipelineDescriptor")?;
            let ptr: *mut c_void = msg_send_0(class.as_ptr(), sel!(alloc));
            if ptr.is_null() {
                return None;
            }
