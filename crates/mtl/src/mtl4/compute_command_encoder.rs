...
use mtl_sys::{msg_send_0, msg_send_1, msg_send_2, msg_send_3, msg_send_4, msg_send_5, sel};
...
impl ComputeCommandEncoder {
    ...
    pub fn copy_indirect_command_buffer(
        ...
        unsafe {
            let range = mtl_foundation::Range::new(source_range_location, source_range_length);
            let _: () = msg_send_4(
                self.as_ptr(),
